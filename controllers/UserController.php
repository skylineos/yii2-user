...
class UserController extends Controller
{
    ...
    public function actionLogin()
    {
        ...
        return $this->render('@vendor/skyline/yii.user/user/views/user/security/login', [
            'model' => $model,
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($model->save()) {
                ...
                $email->template = '@vendor/skyline/yii.user/user/mail/create-account-html';
                $email->params = [
    ...
    public function actionChangePassword()
    {
        ...
        return $this->render('@vendor/skyline/yii.user/user/views/user/recovery/reset', [
            'model' => $model,
            'user' => $user,
        ]);
    }
